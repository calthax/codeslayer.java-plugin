...
const gchar*        java_configuration_get_build_file       (JavaConfiguration *configuration);
void                java_configuration_set_build_file       (JavaConfiguration *configuration,
                                                             const gchar       *build_file);
const gchar*        java_configuration_get_build_directory  (JavaConfiguration *configuration);
void                java_configuration_set_build_directory  (JavaConfiguration *configuration,
