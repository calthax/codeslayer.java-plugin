...
const gchar*        java_indexer_index_get_method_modifier     (JavaIndexerIndex *index);
void                java_indexer_index_set_method_modifier     (JavaIndexerIndex *index,
                                                                const gchar       *method_modifier);
const gchar*        java_indexer_index_get_method_name         (JavaIndexerIndex *index);
void                java_indexer_index_set_method_name         (JavaIndexerIndex *index,
                                                                const gchar      *method_name);
const gchar*        java_indexer_index_get_method_parameters   (JavaIndexerIndex *index);
void                java_indexer_index_set_method_parameters   (JavaIndexerIndex *index,
                                                                const gchar      *method_parameters);
const gchar*        java_indexer_index_get_method_completion   (JavaIndexerIndex *index);
void                java_indexer_index_set_method_completion   (JavaIndexerIndex *index,
                                                                const gchar      *method_completion);
const gchar*        java_indexer_index_get_method_return_type  (JavaIndexerIndex *index);
void                java_indexer_index_set_method_return_type  (JavaIndexerIndex *index,
